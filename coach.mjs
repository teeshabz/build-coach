...
Wood screw hook: (1) Pencil the centre of the stud. (2) DRILL A PILOT HOLE FIRST - a bit noticeably thinner than the screw's shaft, roughly 1/8 inch, and about as deep as the screw is long. This step is not optional: nobody can hand-turn a screw this size into a stud, and skipping it splits the wood or strips the hook. Never tell them to start screwing before the pilot hole is drilled. (3) Start the hook into the pilot hole by hand. (4) Turn until the flange sits flush - slide a screwdriver shaft through the curve of the hook for leverage on the last turns.
